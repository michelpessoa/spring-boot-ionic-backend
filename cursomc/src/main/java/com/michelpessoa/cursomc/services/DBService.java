...
import com.michelpessoa.cursomc.domain.Pagamento;
import com.michelpessoa.cursomc.domain.PagamentoComBoleto;
import com.michelpessoa.cursomc.domain.PagamentoComCartao;
...
import com.michelpessoa.cursomc.repositories.ItemPedidoRepository;
import com.michelpessoa.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p7 = new Produto(null, "TC true Color", 1200.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "54266888694", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("32844544", "981229999"));

		Cliente cli2 = new Cliente(null, "Michel Pessoa ", "michelucg@gmail.com", "57882435562",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("39461000", "981221111"));
		...
		Endereco e3 = new Endereco(null, "Av. Araguaia", "1000", "Apt. 1202", "Centro", "10000000", cli2, c3);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2,
				sdf.parse("20/01/2017 00:00:00"), null);
